...
public class ActEdtDisciplina extends AppCompatActivity implements Serializable{
    ...
    private Disciplina altDisciplina;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_edt_disciplina);
        ...
        //Caso em que a disciplina é recebida para alteração
        Intent i = getIntent();
        altDisciplina = (Disciplina) i.getSerializableExtra("objetoEnviado");
        ...
        //Se foi recebido Disciplina para edição, carregar os campos da tela com os dados da Disciplina
        if(altDisciplina != null) {
            editNome.setText(altDisciplina.getNome());
            editImagem.setText(altDisciplina.getImagem());

            idalt = altDisciplina.getCodigo_disciplina();
    ...
    private void confirmar() {
        ...
        if (validaCampos() == false) {
            try {
                if(alt) {
                    //se for alteração
                    disciplina.setCodigo_disciplina(idalt); //incluindo o código da Disciplina alterada
                    disciplinaRepositorio.alterar(disciplina);
                    Intent i = new Intent(ActEdtDisciplina.this,ActInicio.class);
                    startActivity(i);
                    finish();
                }else{
                //se for inserção
                ...
                if (resultCode == RESULT_OK) {
                    if (data != null) {
                        ...
                        try {
                            ...
                            Toast.makeText(ActEdtDisciplina.this,
