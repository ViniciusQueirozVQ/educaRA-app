...
public class ActCadObjeto extends AppCompatActivity implements Serializable{
    ...
    private ConstraintLayout layoutContentActCadObjeto;
    ...
    private static final String TAG = "ActCadObjeto";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_cad_objeto);
        ...
        if(altObjeto != null){
            ...
            alt = true; //Inica que a operação é de alteração e não de inclusão
        }

        layoutContentActCadObjeto = (ConstraintLayout) findViewById(R.id.layoutContentActCadObjeto);
    ...
    public void onBackPressed(){ //Botão BACK padrão do android
        Intent i = new Intent(this, ActListaObjetos.class);
        i.putExtra("CODIGO", codDisciplina);
        System.out.println("TESTE COD = "+codDisciplina);
        startActivity(i); //O efeito ao ser pressionado do botão (no caso abre a activity)
        ...
        if (validaCampos() == false) {
            try {
                if(alt) {
                    ...
                    Intent i = new Intent(ActCadObjeto.this,ActListaObjetos.class);
                    i.putExtra("CODIGO", codDisciplina);
                    startActivity(i);
                    finish();
                }else{
                    ...
                    Toast.makeText(getApplication(), "Objeto incluído com sucesso!", Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(ActCadObjeto.this,ActListaObjetos.class);
                    i.putExtra("CODIGO", codDisciplina);
                    startActivity(i);
                    finish();
    ...
    private boolean validaCampos() {
        ...
        //Verifica se as extensões
        // Se as extensões não estão corret estão corretasas entra no if e exibe mensagem orientando correção
        else if (!res){
            ...
            System.out.println("EXTENSAO 1 : "+extObj);
            System.out.println("EXTENSAO 2 : "+extPatt);
            System.out.println("EXTENSAO: "+extImg+" "+extMarc);
                ...
                if (resultCode == RESULT_OK) {
                    if (data != null) {
                        ...
                        try {
                            ...
                            Toast.makeText(ActCadObjeto.this,
